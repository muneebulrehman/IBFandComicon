let data = [
	{
		...
		name: 'Akira Toriyama',
		known: `Recognition for his highly successful manga series Dr.Slump, before going on to create Dragon Ball-Z`,
	...
	},
	{
		...
		name: 'Alice Walker',
		known: `first African-American woman to win the Pulitzer Prize for Fiction. In recent years she has spoken out repeatedly in support of Julian Assange.`,
	...
	},
	{
		...
		name: 'Alice Waters',
		known: `Waters has authored the books Chez Panisse Cooking, The Art of Simple Food I and II, and 40 Years of Chez Panisse.`,
	...
	},
	{
		...
		name: 'Anne Tyler',
		known: `Tyler's ninth novel, Dinner at the Homesick Restaurant, was a finalist for the Pulitzer Prize, PEN/Faulkner Award, and the American Book Award for Fiction in 1983.`,
	...
	},
	{
		...
		known: `A professor at Syracuse University, Saunders won the first National Magazine Award for fiction in 1994.`,
	...
	},
	{
		...
		known: `Martin is known for his regular attendance at science fiction conventions and comics conventions, and his accessibility to fans.`,
	...
	},
	{
		img: './images/j-k.jpg',
		name: 'Joanne Rowling',
		known: `Better known by her pen name J. K. Rowling. She is known for the books of Harry Potter and Fantastic Beasts and where to find them.`,
	...
	},
	{
		...
		known: `Jordan Peterson is a Canadian professor of psychology, clinical psychologist, YouTube personality, and author.`,
	...
	},
	{
		...
		name: 'Michio Kaku',
		known: `Author of several books about physics and related topics notably 'The Physics of Impossible' and has made frequent appearances on radio, television, and film.`,
	...
	},
	{
		...
		known: `Received Bram Stoker Awards, World Fantasy Awards, and British Fantasy Society Awards. In 2003, the National Book Foundation awarded him the Medal for Distinguished Contribution to American Letters`,
	...
	},
	{
		...
		known: `McCarthy has received critical acclaim for his writing/direction work for the independent films The Station Agent (2003), The Visitor (2007), Win Win (2011), and Spotlight (2015)`,
